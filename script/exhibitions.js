...
const pages = {
  ...
  5: {
    ...
    text: "In celebration of America’s 250th anniversary, The Bechtler Museum has been selected as one of only ten institutions nationwide to participate in the National Gallery of Art’s Across the Nation initiative. This partnership brings iconic masterpieces to Charlotte, including Edgar Degas’s intimate portrayal of movement in Dancers Backstage, Georgia O’Keeffe’s vibrant floral abstraction Jack-in-Pulpit – No. 2, and Alma Thomas’s rhythmic, seasonal exploration in Autumn Drama. By featuring these celebrated works, the program aims to make world-class cultural treasures more accessible to local communities while highlighting the diverse artistic legacy of the American experience. As Todd Herman, President and CEO of The Bechtler Museum, notes, this collaboration offers a rare opportunity for the public to engage directly with some of the most significant pieces from the National Gallery’s collection in a way that celebrates beauty, innovation, and shared history."
  },
  6: {
    ...
    text: "Established in 1936 as the first art museum in North Carolina, The Bechtler Museum has long served as a pioneer in the region's cultural landscape. This history of leadership is showcased in the Heritage Gallery at Bechtler Museum, which serves as a dedicated space for exploring the institution's transformation. Through a curated selection of artwork, historical photographs, and archival records, the gallery traces the building's journey from its original function as a United States Mint branch to its modern identity as a premier art destination. By documenting these milestones, the installation offers a comprehensive look at the museum's past while pointing toward its future evolution."
  },
  7: {
